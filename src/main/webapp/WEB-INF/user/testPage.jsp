...
<style>
    ...
    /* ----------------------------------------------
     * Generated by Animista on 2024-6-4 18:16:10
...
<form id="1" action="/user/registerTest" method="post">
    ...
    <h3 class="tracking-in-expand">JAVA</h3>

    <h4>사용자로부터 두 개의 정수를 입력받아, 두 수의 최소공배수(LCM)를 계산하여 출력하는 자바 프로그램을 작성하세요.</h4>
    <textarea name="answer1" class="custom_textarea"></textarea>
    <h4>사용자로부터 세 개의 정수를 입력받아, 이 중 가장 작은 값을 찾아 출력하는 자바 프로그램을 작성하세요.</h4>
    <textarea name="answer2" class="custom_textarea"></textarea>
